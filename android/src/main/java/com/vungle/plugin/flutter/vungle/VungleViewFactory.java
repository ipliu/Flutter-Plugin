...
final class VungleViewFactory extends PlatformViewFactory {
    ...
    public VungleViewFactory(@NonNull AdInstanceManager manager) {
    ...
    private static PlatformView getErrorView(@NonNull final Context context, int adId) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            Log.e(VungleViewFactory.class.getSimpleName(), message);
